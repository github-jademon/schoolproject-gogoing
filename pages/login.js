    ...
    <div className="w-full h-full bg-color">
      ...
      <div className="flex-col mt-12">
        <div className="text-center m-4">
          ...
          <div><input type="text" id="id" className="w-60 border-b p-2 focus:outline-none" placeholder="이메일을 입력해주세요" required /></div>
        </div>
        <div className="text-center m-4">
        ...
        <div className="text-center m-4">
          <div className="border rounded inline-block px-2 py-1 w-60 mt-8 hover-base-color hover:text-white base-color">
            <Link href="/">
              <button type="button" className="font-semibold">로그인</button>
            </Link>
          </div>
        </div>
        <div className="text-center m-4">
